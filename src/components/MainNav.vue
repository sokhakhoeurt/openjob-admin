        ...
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            <div class="flex-shrink-0">
              <img class="h-8 w-8" data-src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company" />
            </div>
      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
          <div class="flex items-center px-5">
            <div class="flex-shrink-0">
              <img class="h-10 w-10 rounded-full" :data-src="user.imageUrl" alt="" />
            </div>
            <div class="ml-3">
              <div class="text-1xl font-medium leading-none text-white">{{ user.name }}</div>
